...
Pull requests and pushes to `main` also run coverage, inspect the npm tarball,
and exercise the SDK against disposable SQL Server and DAB 2.0.12 containers.
Release Please manages versions, changelogs, GitHub releases, and npm
